    ...
    translation: {
      ...
      admin: {
        ...
        clients: {
          ...
          rejectError: "Nie udało się odrzucić zgłoszenia.",
          ...
          searchCta: "Szukaj",
          showAllCta: "Pokaż klientów",
          dateFrom: "Data od",
          dateTo: "Data do",
          filterDateCta: "Filtruj daty",
          exportCsvCta: "Eksportuj CSV",
          searching: "Szukam klientów…",
          searchEmpty: "Brak wyników dla podanego zapytania.",
          registeredCount: "Zarejestrowanych klientów: {{count}}",
          approve: "Akceptuj",
          approving: "Akceptuję…",
          reject: "Odrzuć",
          rejecting: "Odrzucam…",
    ...
    translation: {
      ...
      admin: {
        ...
        clients: {
          ...
          searchCta: "Search",
          showAllCta: "Show clients",
          dateFrom: "Date from",
          dateTo: "Date to",
          filterDateCta: "Filter dates",
          exportCsvCta: "Export CSV",
          searching: "Searching clients…",
          searchEmpty: "No results for this query.",
          registeredCount: "Registered clients: {{count}}",
          approve: "Approve",
          approving: "Approving…",
          reject: "Reject",
          rejecting: "Rejecting…",
    ...
    translation: {
      ...
      admin: {
        ...
        clients: {
          ...
          rejectError: "Anfrage konnte nicht abgelehnt werden.",
          ...
          searchCta: "Suchen",
          showAllCta: "Kunden anzeigen",
          dateFrom: "Datum von",
          dateTo: "Datum bis",
          filterDateCta: "Datum filtern",
          exportCsvCta: "CSV exportieren",
          searching: "Kunden werden gesucht…",
          searchEmpty: "Keine Ergebnisse für diese Suche.",
          registeredCount: "Registrierte Kunden: {{count}}",
          approve: "Freigeben",
