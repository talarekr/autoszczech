    ...
    translation: {
      ...
      carDetails: {
        ...
        offerForm: {
          ...
          duplicateAmount: "You have already submitted the same amount for this auction.",
    ...
    translation: {
      ...
      carDetails: {
        ...
        offerForm: {
          ...
          duplicateAmount: "Diesen Betrag hast du für diese Auktion bereits abgegeben.",
...
const ukTranslation = {
  ...
  common: {
    ...resources.pl.translation.common,
    languageSwitcherLabel: "Оберіть мову",
    languages: {
      ...resources.pl.translation.common.languages,
      pl: "Польська",
      en: "Англійська",
      de: "Німецька",
      uk: "Українська",
  ...
  footer: {
    ...resources.pl.translation.footer,
    terms: "Регламент",
  ...
  calculator: {
    ...resources.pl.translation.calculator,
  ...
  transportCalculator: {
    ...resources.pl.translation.transportCalculator,
    badge: "Транспорт",
    title: "Калькулятор транспорту",
    lead: "Розрахуйте орієнтовну вартість мита та транспортування автомобіля з аукціону до Польщі.",
    auctionLabel: "Сума аукціону з комісією",
    auctionPlaceholder: "напр. 45 000",
    auctionHint: "Мито розраховується від суми аукціону разом з комісією.",
    vehicleLabel: "Тип транспортного засобу",
    vehicleHint: "Тариф транспортування залежить від габаритів авто.",
    costIncludes: "Вартість внутрішнього транспорту до Польщі.",
    entity: {
      ...resources.pl.translation.transportCalculator.entity,
      label: "Суб’єкт",
      hint: "Оберіть, чи імпортуєте авто як приватна особа чи компанія.",
      individual: "Фізична особа 19% ПДВ",
      company: "Компанія 0% ПДВ",
    },
    customsLabel: "Мито",
    customsHint: "Оберіть ставку мита відповідно до походження автомобіля.",
    customsOptions: {
      ...resources.pl.translation.transportCalculator.customsOptions,
      nonEu: "Виготовлено поза ЄС — мито 10%",
      eu: "Виготовлено в ЄС — мито 0%",
    },
    additional: {
      ...resources.pl.translation.transportCalculator.additional,
      title: "Розрахунок не включає додаткові витрати, такі як:",
      intro: "Розрахунок не включає додаткові витрати, такі як:",
      items: {
        ...resources.pl.translation.transportCalculator.additional.items,
        excise:
          "Акциз, який сплачує власник авто в Польщі. Наразі діють дві ставки акцизу: 3,1% для авто з об’ємом двигуна до 2000 см³ і 18,6% для авто понад цю межу. Найкраще розраховувати акциз від повної вартості автомобіля.",
        usDuty:
          "З 22 червня 2018 року при імпорті окремих товарів зі США до ЄС може застосовуватися додаткове мито 25%. Це стосується мотоциклів та деяких плавзасобів.",
        loadingFee:
          "Додаткова оплата за завантаження сильно пошкодженого авто, яке не може заїхати на евакуатор своїм ходом. Орієнтовно 50–100 CHF.",
        specialTransport: "Транспортування вантажівок, причепів, спецтехніки та сільськогосподарської техніки — ціна узгоджується індивідуально.",
        pickup: "Самовивіз авто з офісу компанії; доставка за адресою клієнта — за додаткову оплату.",
      },
      contact: "Якщо у вас є запитання, звертайтеся до нашого офісу телефоном або через контактну форму.",
    },
    summary: {
      ...resources.pl.translation.transportCalculator.summary,
      title: "Підсумок",
      description: "Розрахунок базується на вибраній ставці мита та фіксованих транспортних тарифах.",
      auctionValue: "Ціна аукціону (з комісією)",
      auctionPlaceholder: "— введіть суму аукціону —",
      customs: "Мито ({{rate}}%)",
      vat: "ПДВ",
      transportPln: "Транспорт до Польщі (PLN)",
      forwarding: "Експедиція",
      transportCosts: "Транспортні витрати (мито + ПДВ + транспорт + експедиція)",
      registration: {
        ...resources.pl.translation.transportCalculator.summary.registration,
        title: "Можливість реєстрації транспортного засобу *",
        content: "За запитом клієнта підготуємо автомобіль до реєстрації в Польщі. Зв’яжіться з нами для деталей.",
      },
    },
    types: {
      ...resources.pl.translation.transportCalculator.types,
      car: "Легковий автомобіль",
      vanL1L2: "Фургон L1–L2",
      vanL3L4: "Фургон L3–L4",
      motorcycle: "Мотоцикл",
    },
  },
  contact: {
    ...resources.pl.translation.contact,
    badge: "Контакт",
    title: "Зв’яжіться з нами",
    lead: "Оберіть відповідну особу та напишіть нам безпосередньо через форму.",
    sections: {
      ...resources.pl.translation.contact.sections,
      office: {
        ...resources.pl.translation.contact.sections.office,
        title: "Офіс",
        description:
          "Маєте запитання, потрібна оцінка або хочете дізнатися більше про нашу пропозицію? Ми допоможемо підібрати найкраще рішення.",
        phoneLabel: "Телефон",
        emailLabel: "E-mail",
      },
      transport: {
        ...resources.pl.translation.contact.sections.transport,
        title: "Транспорт",
        description:
          "Скористайтеся індивідуальною підтримкою щодо оцінки та організації транспорту. Допоможемо підібрати найкращий маршрут і термін.",
        phoneLabel: "Телефон",
        emailLabel: "E-mail",
      },
    },
    form: {
      ...resources.pl.translation.contact.form,
      badge: "Форма",
      ...
      consent: "Я погоджуюся на обробку персональних даних компанією AutoSzczech.",
      submit: "Надіслати повідомлення",
    },
    location: {
      ...resources.pl.translation.contact.location,
      badge: "Контакт",
      title: "Наша локація",
      hoursTitle: "Години роботи",
      phoneLabel: "Телефон",
      emailLabel: "E-mail",
      mapTitle: "Наша локація",
    },
  },
  clientPanel: {
    ...resources.pl.translation.clientPanel,
    badge: "Обліковий запис клієнта",
    title: "Панель клієнта",
    subtitle: "Керуйте своїми ставками, перевіряйте статус доставки та історію виграних пропозицій в одному місці.",
    tabsLabel: "Навігація",
    tabsHeading: "Панель клієнта",
    tabs: {
      ...resources.pl.translation.clientPanel.tabs,
      offers: "Мої пропозиції",
      favorites: "Улюблені аукціони",
      settings: "Налаштування облікового запису",
    },
    loggedInAs: "Увійшли як {{email}}",
    unauthorized: {
      ...resources.pl.translation.clientPanel.unauthorized,
      badge: "Потрібен вхід",
      title: "Увійдіть, щоб переглянути панель клієнта",
      description: "Доступ до історії ставок і виграних пропозицій можливий після входу в систему.",
      login: "Перейти до входу",
      register: "Створити новий обліковий запис",
    },
    history: {
      ...resources.pl.translation.clientPanel.history,
      heading: "Історія торгів",
      description: "Відстежуйте прогрес активних аукціонів і реагуйте на перебиття ставки.",
      backToAuctions: "Повернутися до аукціонів",
      loading: "Завантажуємо історію ваших ставок…",
      loadError: "Не вдалося завантажити історію ставок. Спробуйте ще раз.",
      empty: "Ви ще не брали участі в жодному аукціоні.",
    },
    offers: {
      ...resources.pl.translation.clientPanel.offers,
      title: "Мої пропозиції",
      description: "Переглядайте активні торги та виграні аукціони, позначені адміністрацією.",
      filters: {
        ...resources.pl.translation.clientPanel.offers.filters,
        ongoing: "Активні",
        won: "Виграні",
        all: "Усі пропозиції",
      },
      emptyActive: "Немає активних аукціонів із вашими ставками.",
      emptyAll: "У вас ще немає історії поданих пропозицій.",
      emptyWon: "У вас ще немає аукціонів, позначених як виграні.",
    },
    favorites: {
      ...resources.pl.translation.clientPanel.favorites,
      heading: "Улюблені аукціони",
      description: "Транспортні засоби, збережені у вашому списку улюблених.",
      loading: "Завантажуємо улюблені транспортні засоби…",
      empty: "Список улюблених порожній.",
      error: "Не вдалося завантажити улюблені транспортні засоби.",
      view: "Переглянути аукціон",
      remove: "Видалити з улюблених",
      location: "Локація: {{location}}",
    },
    wins: {
      ...resources.pl.translation.clientPanel.wins,
      heading: "Виграні пропозиції",
      description: "Підсумок транспортних засобів, які ви виграли останнім часом.",
      empty: "У вас ще немає виграних аукціонів.",
    },
    status: {
      ...resources.pl.translation.clientPanel.status,
      leading: "Ви лідируєте",
      outbid: "Вашу ставку перебито",
      awaiting: "Очікує рішення",
    },
    winnerStatus: {
      ...resources.pl.translation.clientPanel.winnerStatus,
      WON: "Виграно",
      AWARDED: "Перемогу присуджено",
    },
    deliveryStatus: {
      ...resources.pl.translation.clientPanel.deliveryStatus,
      delivered: "Доставлено",
      inTransit: "У дорозі",
      scheduled: "Доставку заплановано",
    },
    fields: {
      ...resources.pl.translation.clientPanel.fields,
      lastBid: "Ваша остання ставка",
      lastBidDate: "Дата останньої ставки",
      totalBids: "Кількість ставок",
      totalBidsValue_one: "{{count}} ставка",
      totalBidsValue_few: "{{count}} ставки",
      totalBidsValue_many: "{{count}} ставок",
      totalBidsValue_other: "{{count}} ставок",
    ...
    actions: {
      ...resources.pl.translation.clientPanel.actions,
      viewOffer: "Переглянути пропозицію",
    },
    settings: {
      ...resources.pl.translation.clientPanel.settings,
      heading: "Налаштування облікового запису",
      description: "Оновіть дані, вказані під час реєстрації. Ви можете змінити e-mail та пароль.",
      emailLabel: "Адреса e-mail",
      passwordLabel: "Новий пароль",
      confirmPasswordLabel: "Підтвердьте пароль",
      helper: "Залиште поле пароля порожнім, якщо не хочете його змінювати.",
      memberSince: "Користувач з {{date}}",
      save: "Зберегти зміни",
      saving: "Збереження…",
      reset: "Відновити дані",
      success: "Дані профілю успішно збережено.",
      error: "Не вдалося оновити профіль. Спробуйте ще раз.",
      duplicateEmail: "Вказана адреса e-mail вже зайнята.",
      passwordMismatch: "Паролі мають збігатися.",
      nothingToUpdate: "Немає змін для збереження.",
    },
  },
  howToBuyPage: {
    ...resources.pl.translation.howToBuyPage,
    badge: "Як купувати",
    title: "Як купувати в AutoSzczech",
    lead: "Дізнайтеся правила участі в аукціонах, спосіб розрахунку та процес доставки автомобіля — крок за кроком.",
    info: {
      ...resources.pl.translation.howToBuyPage.info,
      badge: "Найважливіше",
      title: "Найважливіша інформація",
    },
    highlights: [
      {
        title: "Торги без завдатку",
        description: "Для більшості транспортних засобів ми не вимагаємо внесення забезпечувального платежу. Завдаток потрібен лише для авто вартістю понад 20 000 CHF.",
      },
      {
        title: "Форма оплати",
        description: "Можливий банківський переказ безпосередньо до Швейцарії або оплата готівкою при отриманні авто за попереднім узгодженням.",
      },
      {
        title: "Мито 10%",
        description: "Стосується автомобілів, виготовлених поза ЄС, або тих, що в документах мають позначення «Typenschein X».",
      },
    ],
    process: {
      ...resources.pl.translation.howToBuyPage.process,
      badge: "Процес купівлі",
      title: "Процес купівлі — крок за кроком",
      step: "Крок",
    },
    steps: [
      {
        title: "Подання пропозиції",
        description:
          "Ви подаєте пропозицію на обраний транспортний засіб через наш портал. Аукціони, організовані швейцарськими страховими компаніями, мають тендерний формат — учасники не бачать ставок один одного (так звані закриті торги).\nУвага: кожна подана пропозиція є обов’язковою, і в разі її прийняття виникає обов’язок оплати.",
      },
      {
        title: "Інформація про результат аукціону",
        description:
          "Після завершення аукціону інформація про перемогу з’явиться в панелі клієнта та буде надіслана електронною поштою.\nВиняток становлять аукціони Allianz — вони завжди завершуються о 14:59:59 (з понеділка по п’ятницю), а рішення про присудження авто може тривати до 30 днів. Інформація про перемогу також з’явиться в панелі клієнта.\nТрапляються також ситуації, коли автомобіль може бути присуджений учаснику з «другого місця» — це стосується лише аукціонів страхової компанії SCC.",
      },
      {
        title: "Рішення продавця",
        description:
          "Після завершення аукціону ми очікуємо максимум 30 днів на підтвердження продажу автомобіля. Найчастіше рішення приймається протягом перших двох тижнів.\nЯкщо через 30 днів статус аукціону не зміниться на «присуджено», це означає відсутність прийняття пропозиції продавцем.",
      },
      {
        title: "Завершення покупки",
        description:
          "Після присудження автомобіля потрібно здійснити оплату та заповнити дані покупця в панелі клієнта, надіславши необхідні документи (деталі ви отримаєте e-mail).\nОплата здійснюється міжнародним переказом у валюті CHF або — за домовленістю — готівкою під час доставки. Детальні інструкції надсилаємо на e-mail, вказаний під час реєстрації.",
      },
      {
        title: "Доставка автомобіля",
        description:
          "Автомобіль буде доставлено за вказаною адресою. Нижче ви знайдете перелік документів і додаткових витрат з боку покупця.",
      },
    ],
    delivery: {
      ...resources.pl.translation.howToBuyPage.delivery,
      badge: "Доставка",
      title: "Доставка автомобіля",
      footer:
        "Витрати на акциз, переклади, за потреби висновок експерта, техогляд і збори у відділі комунікації клієнт покриває самостійно.",
    },
    transport: {
      ...resources.pl.translation.howToBuyPage.transport,
      badge: "Транспорт",
      title: "Транспорт",
      bulletTitle: "Індивідуально також оцінюється транспортування:",
      extraFeesTitle: "Можливі додаткові транспортні витрати:",
    },
  },
  home: {
    ...resources.pl.translation.home,
    hero: {
      ...resources.pl.translation.home.hero,
      ...
      points: {
        ...resources.pl.translation.home.hero.points,
    ...
    search: {
      ...resources.pl.translation.home.search,
  ...
  carCard: {
    ...resources.pl.translation.carCard,
    noImage: "Немає фото",
  ...
  carDetails: {
    ...resources.pl.translation.carDetails,
    back: "← Назад",
    returnToList: "← Повернутися до списку аукціонів",
    loading: "Завантаження…",
    fetchError: "Не вдалося завантажити дані транспортного засобу.",
    notFound: "Пропозицію не знайдено.",
    demoMode: "Не вдалося підключитися до API. Показуємо демонстраційні дані.",
    galleryAlt: "Мініатюра транспортного засобу",
    noImage: "Немає фото",
    lightbox: {
      ...resources.pl.translation.carDetails.lightbox,
      open: "Збільшити фото",
    ...
    info: {
      ...resources.pl.translation.carDetails.info,
      mileage: "Пробіг",
      firstRegistration: "Дата першої реєстрації",
      productionYear: "Рік випуску",
      location: "Локація",
    ...
    countdown: {
      ...resources.pl.translation.carDetails.countdown,
      title: "Завершення аукціону",
      noDate: "Дата готується",
    },
    offerForm: {
      ...resources.pl.translation.carDetails.offerForm,
      title: "Подати ставку",
      highestBid: "Найвища ставка",
      minimumBid: "Мінімальна наступна ставка",
      amountLabel: "Сума ставки (CHF)",
      submit: "Підтвердити ставку",
      submitting: "Збереження ставки…",
      success: "Вашу ставку на суму {{amount}} успішно подано.",
      invalidAmount: "Введіть коректну суму ставки.",
      tooLow: "Сума ставки має бути щонайменше {{amount}}.",
      duplicateAmount: "Ви вже подавали таку суму для цього аукціону.",
      notLoggedIn: "Увійдіть, щоб подати ставку.",
      unauthorized: "Сесію завершено. Увійдіть повторно.",
      serverErrorDetails: "Не вдалося зберегти ставку: {{message}}.",
      serverError: "Не вдалося зберегти ставку. Спробуйте ще раз пізніше.",
    },
    favorites: {
      ...resources.pl.translation.carDetails.favorites,
      title: "Додати аукціон в обране",
      subtitle: "Збережіть цю пропозицію, щоб швидко повернутися до неї.",
      addButton: "Додати в обране",
      removeButton: "Видалити з обраного",
      loading: "Збереження…",
      added: "Пропозицію додано в обране.",
      removed: "Пропозицію видалено з обраного.",
      loginHint: "Увійдіть, щоб додавати пропозиції в обране",
      loginLink: "Перейти до входу",
      loginRequired: "Ви маєте увійти, щоб додати пропозицію в обране.",
      error: "Не вдалося зберегти обране. Спробуйте ще раз.",
      loadError: "Не вдалося завантажити ваш список обраного.",
    },
    loginRequired: {
      ...resources.pl.translation.carDetails.loginRequired,
      title: "Участь в аукціоні доступна лише для авторизованих",
      message: "Щоб взяти участь в аукціоні на сайті, потрібно",
      loginLink: "увійти",
      afterLoginLink: "у свій обліковий запис. Ще не маєте акаунта?",
      registerLink: "Перейти до реєстрації",
    },
    description: {
      ...resources.pl.translation.carDetails.description,
      title: "Опис транспортного засобу",
      fallback: "Продавець не додав розширений опис транспортного засобу.",
      translator: {
        ...resources.pl.translation.carDetails.description.translator,
        label: "Перекласти опис",
        helper: "Опис подано німецькою мовою. Оберіть мову та перекладіть текст через Google Translate.",
        selectLabel: "Оберіть мову перекладу",
        action: "Перекласти",
        loading: "Переклад…",
        error: "Не вдалося отримати переклад. Спробуйте ще раз.",
        attribution: "Переклад: Google Translate",
      },
    },
    specs: {
      ...resources.pl.translation.carDetails.specs,
