    ...
    translation: {
      ...
      carDetails: {
        ...
        offerForm: {
          ...
          success: "Twoja oferta została zapisana w trybie demonstracyjnym.",
    ...
    translation: {
      ...
      carDetails: {
        ...
        offerForm: {
          ...
          submit: "Confirm bid",
          success: "Your bid has been recorded in demo mode.",
    ...
    translation: {
      ...
      carDetails: {
        ...
        offerForm: {
          ...
          success: "Ihr Gebot wurde im Demo-Modus gespeichert.",
