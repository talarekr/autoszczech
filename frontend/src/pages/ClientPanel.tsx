...
import { clientBiddingHistory, clientWonAuctions } from "../data/sampleClientActivity";
...
export default function ClientPanel() {
  ...
  const history = useMemo(() => {
    return clientBiddingHistory
      .map((entry) => {
        const car = findCarByIdentifier(entry.carId);
        if (!car) return null;
        return {
          ...entry,
          car,
